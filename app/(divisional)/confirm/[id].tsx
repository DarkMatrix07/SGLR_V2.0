...
const styles = StyleSheet.create({
    ...
    refBox: { backgroundColor: colors.bg, borderRadius: 10, paddingHorizontal: 18, paddingVertical: 10, marginBottom: 8, alignItems: 'center' },
    refLabel: { fontSize: 11, color: colors.textMuted, textTransform: 'uppercase', letterSpacing: 0.8 },
    refValue: { fontSize: 18, fontWeight: '700', color: colors.primaryDark, letterSpacing: 2, marginTop: 2, fontFamily: 'monospace' },
    timestamp: { fontSize: 12, color: colors.textMuted, marginBottom: 24 },
    button: { backgroundColor: colors.primary, paddingHorizontal: 32, paddingVertical: 14, borderRadius: 20 },
